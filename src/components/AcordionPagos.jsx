        ...
        <Page/>
          <div className=' flex flex-col gap-4 text-start text-lg  pl-6 pr-2 text-zinc-300 dark:text-zinc-300'>
            <p className='text-start text-zinc-300 dark:text-zinc-300'>
              Contamos con diferentes métodos de pago para que elijas el que más te convenga:
            </p>
            <ul className='list-disc'>
              <li>Pago en efectivo</li>
              <li>Pago con tarjeta</li>
              <li>Transferencia</li>
              <li>Domiciliación de tarjeta</li>
            </ul>
            <p className=''>
              Para pagar por cualquiera de los métodos anteriores es necesario ingresar al <a href='https://onfiber.trytoku.com/' className='underline font-semibold text-pink-400'>Portal de pago</a> con tu número de cliente y elegir el método deseado.
            </p>
            <p className=' font-bold'>
              Si no conoces tu número de cliente, favor de comunicarte con nosotros vía WhatsApp para que un agente te ayude en el proceso.
            </p>
            ...
            <div className='flex flex-col gap-4 text-start text-lg text-zinc-300 dark:text-zinc-300'>
              ...
              <p>
                Para pagar por Oxxo es necesario ingresar al portal de OnFiber. Al contratar el servicio, recibirás un usuario y contraseña vía SMS al número registrado. Estos datos son necesarios para acceder al portal.
              </p>
              ...
              <p>
                Si no cuentas con estos datos, puedes comunicarte por WhatsApp al siguiente número para que te los proporcionen: <a href="https://wa.link/jh5htf" target="_blank" class="text-pink-400 underline">4493275135</a>.
              </p>
              <p className="mt-2">
        ...
        <AccordionTrigger className='w-full py-0.5 text-left text-zinc-950 dark:text-zinc-50'>
          <div className='flex items-center'>
            ...
            <div className='ml-2 text-zinc-950 dark:text-zinc-50 text-2xl' style={{'color':'#FFB300'}}>
              Cuidados y recomendaciones con el módem
            </div>
          </div>
        </AccordionTrigger>
        <AccordionContent className='origin-left border-b-2 border-white'>
          <div className='flex flex-col gap-4 text-start text-lg pl-6 pr-2 text-zinc-300 dark:text-zinc-300'>
            <p>
              El módem es un dispositivo esencial para conectarse a internet. Actúa como un puente entre la señal de internet que llega a tu domicilio y tus dispositivos electrónicos (computadora, teléfono, tableta, etc.).
            </p>
            <p>
              El rango de alcance del módem es de aproximadamente 5 metros a la redonda para asegurar su efectividad.
            </p>
            <p>
              Si tu módem tiene la capacidad de conexión de doble banda (2.4 GHz y 5 GHz), se recomienda conectarse a la red de 5 GHz para una conexión más rápida y estable.
            </p>
            <p>
              Es importante mantener el módem limpio y libre de plagas de insectos, ya que podrían afectar su funcionamiento. Además, se recomienda manipularlo con cuidado para evitar dañar el cableado interno y afectar su rendimiento.
            </p>
          </div>
        </AccordionContent>
      </AccordionItem>
